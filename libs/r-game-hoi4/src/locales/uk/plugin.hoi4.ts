...
export const uk: typeof en = {
  ...
  technology: {
    ...
    symbolWarning: {
      cancel: 'Скасувати',
      confirm: 'Усе одно зберегти',
      message:
        'Збереження замінить ці константи підстановки простими літералами, розірвавши зв’язок у цьому місці:',
      title: 'Замінити константи підстановки?',
    },
  },
};
